...
export default class ClothingCatalog extends Book {
    ...
    constructor(scene, x, y) {
        ...
        // photoButton11
        const photoButton11 = new PhotoButton(scene, 914, 620);
        page14.add(photoButton11);

        // photoButton10
        const photoButton10 = new PhotoButton(scene, 1178, 377);
        page14.add(photoButton10);

        // photoButton9
        const photoButton9 = new PhotoButton(scene, 916, 373);
        page14.add(photoButton9);

        // photo12
        const photo12 = scene.add.image(1180, 621, "clothingcatalog", "photo/12");
        page14.add(photo12);

        // photo11
        const photo11 = scene.add.image(915, 620, "clothingcatalog", "photo/11");
        page14.add(photo11);

        // photo10
        const photo10 = scene.add.image(1177, 376, "clothingcatalog", "photo/10");
        page14.add(photo10);

        // photo9
        const photo9 = scene.add.image(914, 372, "clothingcatalog", "photo/9");
        page14.add(photo9);
        ...
        // penguin11
        const penguin11 = scene.add.image(911, 629, "clothingcatalog", "photo/penguin");
        ...
        // penguin9
        const penguin9 = scene.add.image(914, 378, "clothingcatalog", "photo/penguin");
        page14.add(penguin9);

        // photoButton8
        const photoButton8 = new PhotoButton(scene, 594, 620);
        page14.add(photoButton8);

        // photoButton7
        const photoButton7 = new PhotoButton(scene, 346, 620);
        page14.add(photoButton7);

        // photoButton6
        const photoButton6 = new PhotoButton(scene, 594, 369);
        page14.add(photoButton6);

        // photoButton5
        const photoButton5 = new PhotoButton(scene, 348, 376);
        page14.add(photoButton5);

        // photo8
        const photo8 = scene.add.image(595, 620, "clothingcatalog", "photo/8");
        page14.add(photo8);

        // photo7
        const photo7 = scene.add.image(348, 620, "clothingcatalog", "photo/7");
        page14.add(photo7);

        // photo6
        const photo6 = scene.add.image(594, 369, "clothingcatalog", "photo/6");
        page14.add(photo6);

        // photo5
        const photo5 = scene.add.image(349, 375, "clothingcatalog", "photo/5");
        page14.add(photo5);

        // penguin8
        const penguin8 = scene.add.image(595, 624, "clothingcatalog", "photo/penguin");
        page14.add(penguin8);

        // penguin7
        const penguin7 = scene.add.image(345, 638, "clothingcatalog", "photo/penguin");
        page14.add(penguin7);

        // penguin6
        const penguin6 = scene.add.image(596, 374, "clothingcatalog", "photo/penguin");
        page14.add(penguin6);

        // penguin5
        const penguin5 = scene.add.image(351, 389, "clothingcatalog", "photo/penguin");
        page14.add(penguin5);
        ...
        // tag1_44
        const tag1_44 = new Tag1(scene, 204, 233);
        ...
        // tag1_45
        const tag1_45 = new Tag1(scene, 237, 122);
        ...
        // tag2_36
        const tag2_36 = new Tag2(scene, 640, 389);
        ...
        // tag2_37
        const tag2_37 = new Tag2(scene, 650, 696);
        ...
        // photoButton4
        const photoButton4 = new PhotoButton(scene, 1162, 620);
        page13.add(photoButton4);

        // photoButton3
        const photoButton3 = new PhotoButton(scene, 924, 620);
        page13.add(photoButton3);

        // photoButton2
        const photoButton2 = new PhotoButton(scene, 1164, 377);
        page13.add(photoButton2);

        // photoButton1
        const photoButton1 = new PhotoButton(scene, 925, 376);
        page13.add(photoButton1);

        // photo4
        const photo4 = scene.add.image(1162, 621, "clothingcatalog", "photo/4");
        page13.add(photo4);

        // photo3
        const photo3 = scene.add.image(922, 620, "clothingcatalog", "photo/3");
        page13.add(photo3);

        // photo2
        const photo2 = scene.add.image(1164, 373, "clothingcatalog", "photo/2");
        page13.add(photo2);

        // photo1
        const photo1 = scene.add.image(924, 374, "clothingcatalog", "photo/1");
        page13.add(photo1);

        // penguin4
        const penguin4 = scene.add.image(1161, 630, "clothingcatalog", "photo/penguin");
        page13.add(penguin4);
        ...
        // penguin2
        const penguin2 = scene.add.image(1168, 370, "clothingcatalog", "photo/penguin");
        page13.add(penguin2);

        // penguin1
        const penguin1 = scene.add.image(927, 382, "clothingcatalog", "photo/penguin");
        penguin1.scaleX = 1.4072155133154731;
        penguin1.scaleY = 0.8207581293249325;
        page13.add(penguin1);

        // tag_16
        const tag_16 = new Tag2(scene, 509, 192);
        ...
        // tag_17
        const tag_17 = new Tag1(scene, 475, 315);
        ...
        // tag_18
        const tag_18 = new Tag1(scene, 430, 701);
        ...
        // tag1_40
        const tag1_40 = new Tag1(scene, 264, 599);
        ...
        // tag2_33
        const tag2_33 = new Tag2(scene, 556, 246);
        ...
        // buyButton
        const buyButton = new BuyButton(scene, 1129, 286, "clothingcatalog", "buy3");
        ...
        // tag1_33
        const tag1_33 = new Tag1(scene, 787, 426);
        ...
        // tag2_26
        const tag2_26 = new Tag2(scene, 542, 183);
        ...
        // tag2_27
        const tag2_27 = new Tag2(scene, 1157, 143);
        ...
        // tag_15
        const tag_15 = new Tag2(scene, 605, 505);
        ...
        // tag1_24
        const tag1_24 = new Tag1(scene, 863, 77);
        tag1_24.angle = 26;
        page9.add(tag1_24);

        // tag1_26
        const tag1_26 = new Tag1(scene, 259, 372);
        ...
        // tag2_22
        const tag2_22 = new Tag2(scene, 623, 494);
        ...
        // tag2_24
        const tag2_24 = new Tag2(scene, 1032, 344);
        tag2_24.scaleX = 1;
        tag2_24.scaleY = 1;
        tag2_24.angle = -22;
        page9.add(tag2_24);
        ...
        // tag2_25
        const tag2_25 = new Tag2(scene, 596, 383);
        ...
        // tag_14
        const tag_14 = new Tag2(scene, 491, 225);
        ...
        // tag1_21
        const tag1_21 = new Tag1(scene, 188, 633);
        tag1_21.scaleX = 1.2;
        tag1_21.scaleY = 1.2;
        ...
        // tag1_22
        const tag1_22 = new Tag1(scene, 517, 384);
        tag1_22.angle = 7;
        page8.add(tag1_22);

        // tag1_23
        const tag1_23 = new Tag1(scene, 308, 158);
        tag1_23.scaleX = 1.3;
        tag1_23.scaleY = 1.3;
        tag1_23.angle = 33;
        page8.add(tag1_23);
        ...
        // tag2_21
        const tag2_21 = new Tag2(scene, 1103, 204);
        tag2_21.scaleX = 1.3;
        tag2_21.scaleY = 1.3;
        tag2_21.angle = -26;
        page8.add(tag2_21);
        ...
        // tag_9
        const tag_9 = new Tag1(scene, 545, 46);
        tag_9.scaleX = 1.3;
        tag_9.scaleY = 1.3;
        tag_9.angle = 22;
        page8.add(tag_9);
        ...
        // tag_10
        const tag_10 = new Tag1(scene, 504, 130);
        tag_10.scaleX = 1.3;
        tag_10.scaleY = 1.3;
        tag_10.angle = 33;
        page8.add(tag_10);
        ...
        // tag_11
        const tag_11 = new Tag2(scene, 1115, 360);
        tag_11.scaleX = 1.3;
        tag_11.scaleY = 1.3;
        tag_11.angle = -31;
        page8.add(tag_11);
        ...
        // tag_12
        const tag_12 = new Tag2(scene, 792, 506);
        tag_12.scaleX = 1.3;
        tag_12.scaleY = 1.3;
        tag_12.angle = -26;
        page8.add(tag_12);
        ...
        // tag_13
        const tag_13 = new Tag1(scene, 896, 189);
        tag_13.scaleX = 1.3;
        tag_13.scaleY = 1.3;
        tag_13.angle = 23;
        page8.add(tag_13);
        ...
        // tag1_19
        const tag1_19 = new Tag1(scene, 770, 365);
        ...
        // tag1_20
        const tag1_20 = new Tag1(scene, 776, 66);
        ...
        // tag2_17
        const tag2_17 = new Tag2(scene, 597, 626);
        ...
        // tag2_18
        const tag2_18 = new Tag2(scene, 1162, 497);
        ...
        // tag2_19
        const tag2_19 = new Tag2(scene, 1072, 183);
        ...
        // tag2_20
        const tag2_20 = new Tag2(scene, 494, 360);
        ...
        // tag_8
        const tag_8 = new Tag2(scene, 1150, 625);
        ...
        // tag1_14
        const tag1_14 = new Tag1(scene, 1072, 763);
        tag1_14.angle = -32.00000000000006;
        page6.add(tag1_14);

        // tag1_15
        const tag1_15 = new Tag1(scene, 764, 610);
        ...
        // tag1_16
        const tag1_16 = new Tag1(scene, 267, 281);
        tag1_16.angle = 30;
        page6.add(tag1_16);

        // tag1_17
        const tag1_17 = new Tag1(scene, 216, 687);
        ...
        // tag1_18
        const tag1_18 = new Tag1(scene, 566, 145);
        tag1_18.angle = 46;
        page6.add(tag1_18);

        // tag2_14
        const tag2_14 = new Tag2(scene, 1018, 236);
        tag2_14.angle = 19;
        page6.add(tag2_14);

        // tag2_15
        const tag2_15 = new Tag2(scene, 1166, 327);
        tag2_15.angle = -24;
        page6.add(tag2_15);

        // tag2_16
        const tag2_16 = new Tag2(scene, 1229, 593);
        tag2_16.angle = 24;
        page6.add(tag2_16);

        // tag_4
        const tag_4 = new Tag2(scene, 849, 348);
        tag_4.angle = -48.00000000000006;
        page6.add(tag_4);

        // tag_5
        const tag_5 = new Tag2(scene, 935, 451);
        tag_5.angle = -23;
        page6.add(tag_5);

        // tag_6
        const tag_6 = new Tag2(scene, 670, 434);
        ...
        // tag_7
        const tag_7 = new Tag2(scene, 432, 405);
        tag_7.angle = -22;
        page6.add(tag_7);
        ...
        // tag1_9
        const tag1_9 = new Tag1(scene, 793, 504);
        ...
        // tag1_10
        const tag1_10 = new Tag1(scene, 232, 520);
        ...
        // tag2_11
        const tag2_11 = new Tag2(scene, 606, 303);
        ...
        // tag2_12
        const tag2_12 = new Tag2(scene, 374, 623);
        ...
        // tag2_13
        const tag2_13 = new Tag2(scene, 425, 171);
        ...
        // tag_2
        const tag_2 = new Tag2(scene, 1125, 509);
        ...
        // tag_3
        const tag_3 = new Tag2(scene, 1121, 202);
        ...
        // tag1_4
        const tag1_4 = new Tag1(scene, 793, 222);
        ...
        // tag1_5
        const tag1_5 = new Tag1(scene, 250, 261);
        ...
        // tag1_7
        const tag1_7 = new Tag1(scene, 787, 475);
        ...
        // tag1_8
        const tag1_8 = new Tag1(scene, 884, 616);
        ...
        // tag2_4
        const tag2_4 = new Tag2(scene, 470, 159);
        ...
        // tag2_5
        const tag2_5 = new Tag2(scene, 631, 517);
        ...
        // tag2_10
        const tag2_10 = new Tag2(scene, 1108, 98);
        ...
        // tag1
        const tag1 = new Tag1(scene, 916, 693);
        ...
        // tag1_1
        const tag1_1 = new Tag1(scene, 226, 513);
        ...
        // tag2
        const tag2 = new Tag2(scene, 1019, 287);
        ...
        // tag2_1
        const tag2_1 = new Tag2(scene, 1195, 336);
        ...
        // tag2_2
        const tag2_2 = new Tag2(scene, 565, 218);
        ...
        // tag
        const tag = new Tag2(scene, 966, 76);
        ...
        // tag_1
        const tag_1 = new Tag2(scene, 1141, 146);
