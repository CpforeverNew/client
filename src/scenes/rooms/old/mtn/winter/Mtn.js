...
export default class Mtn extends RoomScene {
    ...
    _preload() {
        ...
        this.load.pack("mnt-winter-pack", "assets/media/rooms/old/mtn/winter/mnt-winter-pack.json");
    }
    ...
    _create() {
        ...
        // blue_hat_crate
        this.add.image(1072, 398, "mnt-winter", "blue_hat_crate");

        // right_ballons
        this.add.image(1192, 299, "mnt-winter", "right_ballons");
