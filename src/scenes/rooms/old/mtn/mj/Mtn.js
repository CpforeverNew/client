...
export default class Mtn extends RoomScene {
    ...
    _create() {
        ...
        // sky1_png
        this.add.image(765, 189, "mtn-mj", "Sky1.png");

        // water1_png
        const water1_png = this.add.image(760, 694, "mtn-mj", "Water1.png");
        water1_png.scaleX = 1.05;

        // mount1_png
        this.add.image(133, 603, "mtn-mj", "Mount1.png");

        // tree4_png
        this.add.image(66, 677, "mtn-mj", "Tree4.png");

        // lodge1_png
        const lodge1_png = this.add.image(114, 806, "mtn-mj", "Lodge1.png");
        lodge1_png.scaleX = 1.05;
        lodge1_png.scaleY = 1.05;
        ...
        // mountain
        const mountain = this.add.image(34, 214, "mtn-mj", "Hill1.png");
        ...
        // snow1_png
        this.add.image(782, 428, "mtn-mj", "Snow1.png");
        ...
        // tree3_png
        this.add.image(303, 856, "mtn-mj", "Tree3.png");

        // tree2_png
        this.add.image(29, 729, "mtn-mj", "Tree2.png");

        // tree1_png
        this.add.image(86, 800, "mtn-mj", "Tree1.png");

        // sign40001_png
        this.add.image(289, 336, "mtn-mj", "Sign40001.png");

        // sign20001_png
        this.add.image(1278, 632, "mtn-mj", "Sign20001.png");

        // note3_png
        const note3_png = this.add.image(911, 293.47767384373907, "mtn-mj", "Note3.png");
        note3_png.setOrigin(0.5, 0.8585608687498714);

        // statue1_png
        const statue1_png = this.add.image(783, 410.26713714489233, "mtn-mj", "Statue1.png");
        statue1_png.setOrigin(0.5, 0.7600158550788247);

        // note2_png
        const note2_png = this.add.image(595, 322.7781388600415, "mtn-mj", "Note2.png");
        note2_png.setOrigin(0.5, 0.8931663610993572);

        // note1_png
        const note1_png = this.add.image(434, 417.4530226059659, "mtn-mj", "Note1.png");
        note1_png.setOrigin(0.5, 0.9053296777172457);

        // note4_png
        const note4_png = this.add.image(1066, 589.4283713681928, "mtn-mj", "Note4.png");
        note4_png.setOrigin(0.5, 0.9269819040910307);

        // note5_png
        const note5_png = this.add.image(1195, 501.4530226059659, "mtn-mj", "Note5.png");
        note5_png.setOrigin(0.5, 0.8915116205223396);

        // note6_png
        const note6_png = this.add.image(766, 633.391394511533, "mtn-mj", "Note6.png");
        note6_png.setOrigin(0.5, 0.9072605001058074);

        // lists
        const sort = [penguin_run, express, note1_png, note2_png, note3_png, note4_png, note5_png, note6_png, statue1_png];
